  ...
  return (
   ...
   <div className="absolute top-0 -left-4 w-72 h-72 bg-purple-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
    ...
    <div className='text-center w-3/5 m-auto p-10 rounded-3xl shadow-md shadow-teal-500/50 border-4 border-emerald-100 opacity-100 backdrop-blur-sm bg-teal/30 font-bold'  style={{background:'#ffffff'}}>
      ...
      <Link to={"/selectappliances"}><button className='px-5 py-4 text-3xl  mt-5 rounded-full transition ease-in-out delay-150 bg-teal-500 hover:-translate-y-1 hover:scale-110 hover:bg-cyan-500 duration-300 brightness-100 font-bold' style={{background:'0e766d'}}><p className='' style={{color:'#ffffff'}}>Get Started</p></button></Link>
    </div>
    </div>
  )
}
